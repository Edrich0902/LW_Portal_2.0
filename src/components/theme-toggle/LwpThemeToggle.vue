<script setup lang="ts">
  ...
  const currentIcon = computed(() => options.find(o => o.value === themeStore.mode)?.icon ?? 'pi pi-desktop')
...
<template>
  <Button :icon="currentIcon" severity="secondary" text rounded aria-label="Toggle theme" @click="popover.toggle($event)" />
  <Popover ref="popover">
